...
class ChurchController {
    ...
    def save(Church churchInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'church.label', default: 'Church'), churchInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'church.label', default: 'Church'), params.id])
                redirect action: "index", method: "GET"
            }
