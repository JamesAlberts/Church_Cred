		...
		<div id="list-member" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="memberPassword" title="${message(code: 'member.memberPassword.label', default: 'Member Password')}" />
					
						<g:sortableColumn property="memberEmail" title="${message(code: 'member.memberEmail.label', default: 'Member Email')}" />
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: memberInstance, field: "memberPassword")}</td>
					
						<td>${fieldValue(bean: memberInstance, field: "memberEmail")}</td>
